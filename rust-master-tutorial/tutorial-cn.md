...
% Rust 语言教程 master-2014-01-02 itang
...
Rust是一门集中在类型安全，内存安全，并发以及性能的编程语言。它的目的是用来写大规模，
高性能的软件，并能避免其中的各类常见错误。Rust具有一个精密的内存模型，
能够鼓励有效的数据结构和安全并发模式的使用，避免可能回导致分段错误的非法安全访问。
Rust是一个预先编译的静态类型语言。
...
作为一门多范式的语言，Rust支持过程式，函数式和面向对象式的编程风格。
它的一些让人感觉很爽的高级特性包括：
* **类型推断** 
* **基于任务的安全并发**
* **高阶函数**
